...
<script type="text/javascript" src="https://asciinema.org/a/azxc5fdk57knm64zmhkuaasf4.js" id="asciicast-azxc5fdk57knm64zmhkuaasf4" async></script>
...
بعدش از شما رمز میخواد. بسته به `pinentry` نصب شده روی سیستم شما، این گرفتن رمز ممکنه با روش متفاوتی از شما گرفته بشه. برای من توی X11 گرفته میشه ولی میتونید ‍‍`pinentry-curses` رو تنظیم کنید تا اونم توی ترمینال باشه که خوب برای من زیاد مهم نیست :)
